...
import { buildSyncTasks, detectLang, removeExt, artifactRelativePathForCode, buildReport, } from './artifact-sync.js';
...
describe('artifactRelativePathForCode', () => {
    ...
    it('maps code path to doc path', () => {
        expect(artifactRelativePathForCode('src/main.ts', 'docs', '.html')).toBe('docs/src/main.html');
    });
});
